...
resource "hcso_waf_rule_cc_protection" "test" {
...
```bash
$ terraform import hcso_waf_rule_cc_protection.test <policy_id>/<rule_id>
```

* Using `policy_id`, `rule_id` and `enterprise_project_id`, separated by slashes, e.g.

```bash
$ terraform import hcso_waf_rule_cc_protection.test <policy_id>/<rule_id>/<enterprise_project_id>
```
