...
```hcl
resource "hcso_vpnaas_ike_policy_v2" "policy_1" {
  name = "my_policy"
}
```
...
```
$ terraform import hcso_vpnaas_ike_policy_v2.policy_1 832cb7f3-59fe-40cf-8f64-8350ffc03272
```
