...
provider "kubernetes" {
  host                   = "https:/${hcso_vpc_eip.cce.address}:5443"
  cluster_ca_certificate = base64decode(hcso_cce_cluster.cluster.certificate_clusters[0].certificate_authority_data)
  client_certificate     = base64decode(hcso_cce_cluster.cluster.certificate_users[0].client_certificate_data)
  client_key             = base64decode(hcso_cce_cluster.cluster.certificate_users[0].client_key_data)
}
